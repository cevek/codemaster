...
const EXCLUSIONS: Record<string, string> = {
  ...
  symbols_overview:
    'a flat BARE-NAME catalogue (no file:line decoration by design — the density point) — carries no proof Spans; the ⊇-oracle / grouping / cap honesty is oracle-tested in symbols-overview.test.ts vs a cold ts.Program checker',
  invalidations_for:
  ...
  trace_field_to_render:
    'requires the react plugin (not enabled in this generic sweep fixture); proof-span validity is oracle-tested in trace-field-to-render.test.ts via assertSpansValid',
  find_unused_props:
