...
export const traceInvalidationOp = defineOp({
  ...
  async run(ctx, args) {
    ...
    const refusal = semanticFanoutRefusal(ctx, ts, args.force, { op: 'trace_invalidation', args });
