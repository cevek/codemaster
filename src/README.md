...
| L1    | `support/`      | external-tool wrappers — `git/`, `prettier/`, `text-edits/`, `fs/`, `sql/`, `transport/` (unix-socket + NDJSON, the daemon's wire), `usage-log/` (jsonl usage telemetry), `watchdog/` (the never-hang backstops §1: a worker-thread breadcrumb watchdog + orphan poll) (I/O lives here, nowhere else)                                                                                                                                                                                                                                | common, core, config                                                 |
