...
| L0.5  | `common/`       | pure logic over core types — `result/`, `ids/`, `span/`, `confidence/`, `fingerprint/`, `plugin-registry/`, `async/`, `debug-spec/`, `lru/`, `shape-tag/` (the `~shape` render-dispatch vocabulary), `truncate/` (the truncation chokepoint: `elideString`/`elideType`+CapId registry / `capList` / `nameWithMore` — §3.4). No I/O, no timers (Clock seam only)                                                                                                                                                                                                                                           | core                                                                 |
